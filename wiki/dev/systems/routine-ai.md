...
*(Note: Bath and Leisure searches also rely on the `nextXSearchTick` cooldown to prevent search storms, even though they are routed from IDLE instead of being global interrupts.)*
