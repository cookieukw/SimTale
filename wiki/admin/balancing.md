...
Per tick, from `NeedsHelper.tickDecay` (Adults):
...
Per tick, from `BabyNeeds.tickDecay` (Babies/Children):

| Need | Rate | Condition |
|---|---|---|
| Hunger | 0.0003 | — |
| Affection | 0.0002 | — |
| Health | 0.0001 | 0.0004 if Hunger < 20 |
| Negative Experiences | +0.001 | if Hunger, Affection, or Health < 30 |
