...
- **Conversas NPC-com-NPC**: Quando dois moradores se encontram durante suas rotinas diárias, eles param frente a frente e conversam turno-a-turno. Os assuntos são contextuais (fazendeiros conversam sobre a lavoura, NPCs exaustos comentam sobre cama/sono, famintos falam de comida, e inimigos trocam ofensas antes de se empurrarem). Os diálogos possuem intervalos equilibrados (cooldown de 40 a 60s pós-conversa) para evitar que fiquem aglomerados o dia todo, os moradores dão passeios amplos pelas ruas da vila (até 48 blocos) e respeitam o espaço pessoal uns dos outros (1,15m de separação). NPCs em plena caminhada não são interrompidos por convites distantes. O bate-papo é audível no chat em um raio de até 4 blocos.
