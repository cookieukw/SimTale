...
| Requisito | Qualquer bloco cujo id contenha | Exemplos |
|---|---|---|
| **Fonte de luz** | `torch` (tocha), `lantern` (lanterna), `candle` (vela), `campfire` (fogueira), `glow` (brilho), `lamp` (lâmpada), `chandelier` (lustre) | <img src="/img/furniture/lights/Wood_Torch_Wall.png" width="22" align="absmiddle" title="Tocha" /> <img src="/img/furniture/lights/Furniture_Village_Lantern.png" width="22" align="absmiddle" title="Lanterna" /> <img src="/img/furniture/lights/Furniture_Tavern_Chandelier.png" width="22" align="absmiddle" title="Lustre" /> |
| **Assento** | `chair` (cadeira), `stool` (banquinho), `bench` (banco), `seat` (assento), `sofa` (sofá), `couch` (sofá) | <img src="/img/furniture/seats/Furniture_Village_Chair.png" width="22" align="absmiddle" title="Cadeira da Vila" /> <img src="/img/furniture/seats/Furniture_Tavern_Chair.png" width="22" align="absmiddle" title="Cadeira de Taverna" /> <img src="/img/furniture/seats/Furniture_Grand_Wizard_Bench.png" width="22" align="absmiddle" title="Banco" /> |
| **Superfície** | `table` (mesa), `workbench` (bancada), `desk` (escrivaninha), `counter` (balcão) | <img src="/img/furniture/tables/Furniture_Village_Table.png" width="22" align="absmiddle" title="Mesa da Vila" /> <img src="/img/furniture/tables/Furniture_Tavern_Table.png" width="22" align="absmiddle" title="Mesa de Taverna" /> <img src="/img/furniture/tables/Furniture_Village_Counter.png" width="22" align="absmiddle" title="Balcão" /> |

<details>
  <summary>Ver todas as fontes de luz (44)</summary>
...
<details>
  <summary>Ver todos os assentos (49)</summary>
  <div className="furniture-gallery">
...
<details>
  <summary>Ver todas as superfícies e mesas (19)</summary>
  <div className="furniture-gallery">
...
| Item | Por quê | Exemplos |
|---|---|---|
| **Cama** | Sem uma, ninguém mora lá. A casa é identificada *pela sua cama*. | <img src="/img/furniture/beds/Furniture_Village_Bed.png" width="22" align="absmiddle" title="Cama da Vila" /> <img src="/img/furniture/beds/Furniture_Tavern_Bed.png" width="22" align="absmiddle" title="Cama de Taverna" /> <img src="/img/furniture/beds/Furniture_Lumberjack_Bed.png" width="22" align="absmiddle" title="Cama de Lenhador" /> |
| **Baú** | Sem um, os residentes não têm de onde tirar comida. | <img src="/img/furniture/chests/Furniture_Village_Chest_Small.png" width="22" align="absmiddle" title="Baú Pequeno" /> <img src="/img/furniture/chests/Furniture_Tavern_Chest_Large.png" width="22" align="absmiddle" title="Baú Grande" /> <img src="/img/furniture/chests/Furniture_Tavern_Barrel.png" width="22" align="absmiddle" title="Barril" /> |

<details>
  <summary>Ver todas as camas (16)</summary>
  <div className="furniture-gallery">
...
<details>
  <summary>Ver todos os baús e armazenamento (48)</summary>
  <div className="furniture-gallery">
...
Uma porta ocupa quatro blocos, e duas portas lado a lado formam uma porta dupla. NPCs abrem e fecham
portas ao passar. (Hodor ficaria orgulhoso).

<details>
  <summary>Ver todas as portas e alçapões (47)</summary>
  <div className="furniture-gallery">
