...
- **NPC-to-NPC Conversations**: When two NPCs meet during their daily routines, they stop, face each other, and converse turn-by-turn. Dialogue topics adapt to their actual context (farmers talk about crops, exhausted NPCs talk about sleep, starving NPCs discuss food, and enemies trade insults before shoving each other). Conversations have balanced cooldowns (40–60s between talks) so villagers don't stay glued together, and villagers take leisurely strolls across village streets (up to 48 blocks) while respecting each other's personal space (1.15m separation). NPCs actively walking on a stroll are protected and won't be interrupted by distant social calls. Chatter is audible in chat within a 4-block radius.
